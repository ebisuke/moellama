...
with jsonlines.open(os.path.join("./","dlg/empdial/raw/train.jsonl"),"r") as f:
    for line in f:
        jpdlg_train.append(line)
with jsonlines.open(os.path.join("./","dlg/perchat/raw/train.jsonl"),"r") as f:
    for line in f:
        jpdlg_train.append(line)
with jsonlines.open(os.path.join("./","dlg/empdial/raw/valid.jsonl"),"r") as f:
    for line in f:
        jpdlg_eval.append(line)
with jsonlines.open(os.path.join("./","dlg/perchat/raw/valid.jsonl"),"r") as f:
    for line in f:
        jpdlg_eval.append(line)
jpdlg_eval=parse_noja.load_openai(jpdlg_eval)
jpdlg_train=parse_noja.load_openai(jpdlg_train)
noja=jpdlg_train
noja_winlose=jpdlg_eval
